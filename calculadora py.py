...
b_1 = Button(frame_corpo, command=limpar_tela,text="Apagar", width=11, height=2, bg=cor2, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=0)
...
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, command=lambda:entrar_valores('/'), text="/", width=5, height=2, bg=cor3, fg=cor2, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_7 = Button(frame_corpo, command=lambda:entrar_valores('*'),text="*", width=5, height=2, bg=cor3, fg=cor2, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
...
b_18 = Button(frame_corpo, command=calcular,text="=", width=5, height=2, bg=cor3, fg=cor2, font=("Ivy 13 bold"), relief=RAISED, overrelief=RIDGE)
